...
module.exports = function(io) {
    ...
    router.get('/dashboard', requireAdmin, async (req, res) => {
      try {
        ...
        res.status(500).render('errores', { mensaje: 'Error cargando el dashboard' });
      }
    });
    ...
    router.get('/control', requireAdmin, async (req, res) => {
      try {
        ...
        res.status(500).render('errores', { mensaje: 'Error cargando el panel de control' });
      }
    });
    ...
    router.get('/cartones', requireAdmin, async (req, res) => {
        try {
            ...
            res.status(500).render('errores', { mensaje: 'Error: ' + error.message });
        }
    });
